...
<head>
    <meta charset="UTF-8">
    <title>Welcome to BSG CodeIgniter 4!</title>
...
<section>
    ...
    <p>앱으로 연결되는것까지만 볼거야.:</p>

    <pre><code>app/Views/bsghome.php</code></pre>
...
<div class="further">
    ...
    <section>
        ...
        <h2>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><rect x='32' y='96' width='64' height='368' rx='16' ry='16' class="svg-stroke" />
            <line x1='112' y1='224' x2='240' y2='224' class="svg-stroke" /><line x1='112' y1='400' x2='240' y2='400' class="svg-stroke" />
            <rect x='112' y='160' width='128' height='304' rx='16' ry='16' class="svg-stroke" /><rect x='256' y='48' width='96' height='416' rx='16' ry='16' class="svg-stroke" />
